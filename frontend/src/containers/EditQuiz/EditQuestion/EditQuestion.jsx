...
const initialState = {
  ...
  content: 'hey',
  options: [
    {id: 12, content: 'aaaaaa', iscorrect: false}
  ]
}
...
const reducer = (state, action) => {
  switch(action.type){
    ...
    case 'CHANGE_OPTION_CONTENT': return changeOptionContent(state, action);
    case 'CHECK_TOGGLE': return checkToggleAction(state, action);
    case 'DELETE_OPTION': return deleteOptionAction(state, action);
                ...
                return (
                  ...
                  >
                      {/* {option.content} */}
                        ...
                        <DeleteIcon className={classes.DeleteOption} onClick={deleteOption}/>
